 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
reversed = alphabetArray.reverse();
console.log(reversed);


let arrayString = alphabetArray.join('');
...
//step 2, print 3rd element
console.log(array1[2]);

//step 3, print last element
console.log(array1[array1.length - 1]);

//step 4, add 16 and 3 to array1 and print
array1.push(16, 3);
console.log(array1);

//step 5, print 3rd element again
console.log(array1[2]);

//step 6, print last element again
console.log(array1[array1.length - 1]);
...
//create array
let myTodoList = [];
myTodoList.push("wash", "wax", "buff");
console.log("step 2: ", myTodoList);

//remove second element, removes buff
myTodoList.splice(2, 1);

//expecting wash, wax
console.log("step 3: ", myTodoList);

let yourTodoList = ['scratch', 'dent'];

let ourTodoList = myTodoList.concat(yourTodoList);

//expecting wash, wax, scratch, dent
console.log("step 5, using concat method: ", ourTodoList);
